...
- New "Progress style" setting in the Fuse tab: alongside the classic
  burn-down fuse, a "Build up" mode starts the fuse empty and grows it
  toward the deadline, with a pulsing charge trail behind the leading tip.
